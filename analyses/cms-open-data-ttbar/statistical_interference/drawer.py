...
class DrawModel:
    ...
    predefined_colors = [
        ROOT.TColor.GetColor("#3F90DA"),  # check choosen colors here: https://arxiv.org/abs/2107.02270
    ...
    def __init__(self, meas, ws):
        self.meas = meas
        self.ws = ws
        self.cv_array = [] # save all ROOT Graphic objects as self to be able show picture in main notebook
        self.hs_stacks = []
